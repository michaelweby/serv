                                ...
                                <div class="col-lg-3">
                                    <div class="padd">
                                       ...
                                       <span class="glyphicon glyphicon-trash">
                                            ...
                                            &nbsp;
                                            <a href="class.html" class="btn btn-success btn-xs" data-toggle="tooltip" title="التفاصيل"><span class="glyphicon glyphicon-edit"></span></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                            ...
                                            <div class="modal-body">
                                                <div class="row m-t-lg">
                                                    <div class="col-sm-12 ">
                                                        ...
                                                        <form role="form">
                                                            <!--  -->
                                                            <div class="form-group"> <input type="text" value="خدمة اولى ابتدائى" class="form-control"></div>
                                                            <!--  -->
